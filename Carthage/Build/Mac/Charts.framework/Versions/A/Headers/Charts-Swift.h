...
- (NSArray<NSColor *> * __nullable)getColors;
...
- (void)setValueTextColor:(NSColor * __null_unspecified)color;

/// Sets the font for all value-labels for all DataSets this data object contains.
- (void)setValueFont:(NSFont * __null_unspecified)font;
...
@property (nonatomic, readonly, copy) NSArray<NSColor *> * __nonnull valueColors;
...
@property (nonatomic, readonly, copy) NSArray<NSColor *> * __nonnull colors;

/// \returns  the color at the given index of the DataSet's color array.
/// This prevents out-of-bounds by performing a modulus on the color index, so colours will repeat themselves.
- (NSColor * __nonnull)colorAt:(NSInteger)index;
- (void)resetColors;
- (void)addColor:(NSColor * __nonnull)color;
- (void)setColor:(NSColor * __nonnull)color;
...
@property (nonatomic, strong) NSColor * __nonnull valueTextColor;

/// \returns  the color at the specified index that is used for drawing the values inside the chart. Uses modulus internally.
- (NSColor * __nonnull)valueTextColorAt:(NSInteger)index;

/// the font for the value-text labels
@property (nonatomic, strong) NSFont * __nonnull valueFont;
...
@property (nonatomic, strong) NSColor * __nonnull highlightColor;
...
@property (nonatomic, strong) NSColor * __nonnull barShadowColor;
...
/// All the colors that are used for this DataSet. Colors are reused as soon as the number of Entries the DataSet represents is higher than the size of the colors array.
@property (nonatomic, copy) NSArray<NSColor *> * __nonnull colors;

/// List representing all colors that are used for drawing the actual values for this DataSet
@property (nonatomic, copy) NSArray<NSColor *> * __nonnull valueColors;
...
/// </code>
- (void)setColor:(NSColor * __nonnull)color alpha:(CGFloat)alpha;
...
/// </code>
- (void)setColors:(NSArray<NSColor *> * __nonnull)colors alpha:(CGFloat)alpha;
...
- (void)drawValueWithContext:(CGContextRef __nonnull)context value:(NSString * __nonnull)value xPos:(CGFloat)xPos yPos:(CGFloat)yPos font:(NSFont * __nonnull)font align:(NSTextAlignment)align color:(NSColor * __nonnull)color;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
- (BOOL)passesCheck;
@end
...
- (void)touchesBeganWithEvent:(NSEvent * __nonnull)event;
- (void)touchesEndedWithEvent:(NSEvent * __nonnull)event;
- (void)touchesMovedWithEvent:(NSEvent * __nonnull)event;
- (void)touchesCancelledWithEvent:(NSEvent * __nonnull)event;
- (void)nsuiTouchesBegan:(NSSet<NSTouch *> * __nonnull)touches withEvent:(NSEvent * __nullable)event;
- (void)nsuiTouchesMoved:(NSSet<NSTouch *> * __nonnull)touches withEvent:(NSEvent * __nullable)event;
- (void)nsuiTouchesEnded:(NSSet<NSTouch *> * __nonnull)touches withEvent:(NSEvent * __nullable)event;
- (void)nsuiTouchesCancelled:(NSSet<NSTouch *> * __nullable)touches withEvent:(NSEvent * __nullable)event;
@property (nonatomic, strong) NSColor * __nullable backgroundColor;
...
@property (nonatomic, strong) NSFont * __nullable descriptionFont;

/// Text color used for drawing the description text
@property (nonatomic, strong) NSColor * __nullable descriptionTextColor;
...
@property (nonatomic, strong) NSFont * __null_unspecified infoFont;
@property (nonatomic, strong) NSColor * __null_unspecified infoTextColor;
...
- (NSImage * __nullable)getChartImageWithTransparent:(BOOL)transparent;
...
@property (nonatomic, strong) NSColor * __nonnull gridBackgroundColor;
@property (nonatomic, strong) NSColor * __nonnull borderColor;
...
@property (nonatomic, strong) NSClickGestureRecognizer * __null_unspecified _tapGestureRecognizer;
@property (nonatomic, strong) NSClickGestureRecognizer * __null_unspecified _doubleTapGestureRecognizer;
@property (nonatomic, strong) NSMagnificationGestureRecognizer * __null_unspecified _pinchGestureRecognizer;
@property (nonatomic, strong) NSPanGestureRecognizer * __null_unspecified _panGestureRecognizer;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)initialize;
- (void)drawRect:(CGRect)rect;
...
- (BOOL)gestureRecognizerShouldBegin:(NSGestureRecognizer * __nonnull)gestureRecognizer;
- (BOOL)gestureRecognizer:(NSGestureRecognizer * __nonnull)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(NSGestureRecognizer * __nonnull)otherGestureRecognizer;
...
@property (nonatomic, strong) NSColor * __nullable shadowColor;
...
@property (nonatomic, strong) NSColor * __nullable neutralColor;

/// color for open > close
@property (nonatomic, strong) NSColor * __nullable increasingColor;

/// color for open < close
@property (nonatomic, strong) NSColor * __nullable decreasingColor;
...
@property (nonatomic, strong) NSFont * __nonnull labelFont;
@property (nonatomic, strong) NSColor * __nonnull labelTextColor;
@property (nonatomic, strong) NSColor * __nonnull axisLineColor;
...
@property (nonatomic, strong) NSColor * __nonnull gridColor;
...
+ (NSArray<NSColor *> * __nonnull)liberty;
+ (NSArray<NSColor *> * __nonnull)joyful;
+ (NSArray<NSColor *> * __nonnull)pastel;
+ (NSArray<NSColor *> * __nonnull)colorful;
+ (NSArray<NSColor *> * __nonnull)vordiplom;
+ (NSColor * __nonnull)colorFromString:(NSString * __nonnull)colorString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (nonnull instancetype)initWithColor:(NSColor * __nonnull)color;
...
- (nonnull instancetype)initWithImage:(NSImage * __nonnull)image tiled:(BOOL)tiled;
- (nonnull instancetype)initWithCGImage:(CGImageRef __nonnull)CGImage;
- (nonnull instancetype)initWithImage:(NSImage * __nonnull)image;
...
+ (ChartFill * __nonnull)fillWithColor:(NSColor * __nonnull)color;
...
+ (ChartFill * __nonnull)fillWithImage:(NSImage * __nonnull)image tiled:(BOOL)tiled;
+ (ChartFill * __nonnull)fillWithCGImage:(CGImageRef __nonnull)CGImage;
+ (ChartFill * __nonnull)fillWithImage:(NSImage * __nonnull)image;
...
@property (nonatomic, strong) NSFont * __nonnull font;
...
- (CGSize)getMaximumEntrySize:(NSFont * __nonnull)font;
- (NSString * __nullable)getLabel:(NSInteger)index;
- (CGSize)getFullSize:(NSFont * __nonnull)labelFont;
...
- (void)calculateDimensionsWithLabelFont:(NSFont * __nonnull)labelFont viewPortHandler:(ChartViewPortHandler * __nonnull)viewPortHandler;
...
- (void)drawLabelWithContext:(CGContextRef __nonnull)context x:(CGFloat)x y:(CGFloat)y label:(NSString * __nonnull)label font:(NSFont * __nonnull)font textColor:(NSColor * __nonnull)textColor;
@end
...
@property (nonatomic, strong) NSColor * __nonnull lineColor;
...
@property (nonatomic, strong) NSImage * __nullable image;
...
@property (nonatomic, strong) NSColor * __nullable zeroLineColor;
...
@property (nonatomic, strong) NSColor * __nonnull fillColor;
...
@property (nonatomic, copy) NSArray<NSColor *> * __nonnull circleColors;

/// \returns  the color at the given index of the DataSet's circle-color array.
/// Performs a IndexOutOfBounds check by modulus.
- (NSColor * __nullable)getCircleColor:(NSInteger)index;

/// Sets the one and ONLY color that should be used for this DataSet. Internally, this recreates the colors array and adds the specified color.
- (void)setCircleColor:(NSColor * __nonnull)color;
...
@property (nonatomic, strong) NSColor * __nonnull circleHoleColor;
...
@property (nonatomic, strong) NSColor * __nullable scatterShapeHoleColor;
...
- (void)drawFilledPathWithContext:(CGContextRef __nonnull)context path:(CGPathRef __nonnull)path fillColor:(NSColor * __nonnull)fillColor fillAlpha:(CGFloat)fillAlpha;
@end
...
@property (nonatomic, readonly) CGImageRef __nullable CGImage;
@end
...
- (NSPoint)nsuiLocationOfTouch:(NSInteger)touch inView:(NSView * __nullable)inView;
@end
...
- (NSPoint)locationInView:(NSView * __nonnull)view;
@end



@interface NSView (SWIFT_EXTENSION(Charts))
@property (nonatomic, readonly, copy) NSArray<NSGestureRecognizer *> * __nullable nsuiGestureRecognizers;
@end
...
@property (nonatomic, strong) NSColor * __nullable holeColor;
...
/// </code>
@property (nonatomic, strong) NSColor * __nullable transparentCircleColor;
...
@property (nonatomic, strong) NSColor * __nonnull webColor;

/// color for the web lines in between the lines that come from the center.
@property (nonatomic, strong) NSColor * __nonnull innerWebColor;
